...
class ControllerChannelManager(controllerContext: ControllerContext,
  ...
  def startup() = {
    ...
    //System.out.println("【日志】ControllerChannelManager.startup()")
  ...
  def sendRequest(brokerId: Int, request: AbstractControlRequest.Builder[_ <: AbstractControlRequest], callback: AbstractResponse => Unit = null): Unit = {
    ...
    //System.out.println("【日志】ControllerChannelManager.sendRequest() 集群消息添加到待发送queue中,目标brokerId="+brokerId+",request.ApiKey="+request.apiKey)
  ...
  private def addNewBroker(broker: Broker): Unit = {
    ...
    //System.out.println("【日志】ControllerChannelManager.addNewBroker()")
      ...
      while (isRunning && !isSendSuccessful) {
        ...
        try {
          if (!brokerReady()) {
            ...
            //System.out.println("【日志】ControllerChannelManager.RequestSendThread.doWork() 轮训到队列中待发送请求 ApiKeys="+clientRequest.apiKey())
...
abstract class AbstractControllerBrokerRequestBatch(config: KafkaConfig,
  ...
  def addUpdateMetadataRequestForBrokers(brokerIds: Seq[Int],
    ...
    //System.out.println("【日志】ControllerChannelManager.addUpdateMetadataRequestForBrokers() 发送请求元数据更新请求");
  ...
  private def sendLeaderAndIsrRequest(controllerEpoch: Int, stateChangeLog: StateChangeLogger): Unit = {
    ...
    //System.out.println("【日志】ControllerChannelManager.sendLeaderAndIsrRequest() 发送ISR变更消息");
  ...
  def sendRequestsToBrokers(controllerEpoch: Int): Unit = {
    ...
    //System.out.println("【日志】ControllerChannelManager.sendRequestsToBrokers()");
