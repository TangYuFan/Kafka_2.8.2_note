...
class KafkaController(val config: KafkaConfig,
  ...
  private def onControllerFailover(): Unit = {
    ...
    //System.out.println("【日志】KafkaController.onControllerFailover()")
  ...
  private def onNewPartitionCreation(newPartitions: Set[TopicPartition]): Unit = {
    ...
    //System.out.println("【日志】KafkaController.onNewPartitionCreation() 处理分区创建:"+newPartitions);
  ...
  private def initializeControllerContext(): Unit = {
    ...
    //System.out.println("【日志】KafkaController.initializeControllerContext()")
  ...
  private[controller] def sendUpdateMetadataRequest(brokers: Seq[Int], partitions: Set[TopicPartition]): Unit = {
    ...
    //System.out.println("【日志】KafkaController.sendUpdateMetadataRequest() 发送元数据更新请求");
  ...
  private def processStartup(): Unit = {
    //System.out.println("【日志】KafkaController.processStartup()")
  ...
  private def elect(): Unit = {
    ...
    //System.out.println("【日志】KafkaController.elect()")
  ...
  private def processTopicChange(): Unit = {
    ...
    //System.out.println("【日志】KafkaController.processTopicChange() 处理集群主题变更事件");
  ...
  override def process(event: ControllerEvent): Unit = {
    ...
    //System.out.println("【日志】KafkaController.process() 事件类型:"+event)
...
class TopicChangeHandler(eventManager: ControllerEventManager) extends ZNodeChildChangeHandler {
  ...
  override def handleChildChange(): Unit = {
    //System.out.println("【日志】KafkaController.handleChildChange() 调用eventManager添加TopicChange的event");
