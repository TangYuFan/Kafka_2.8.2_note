...
class ZkPartitionStateMachine(config: KafkaConfig,
  ...
  override def handleStateChanges(
    ...
    //System.out.println("【日志】PartitionStateMachine.handleStateChanges() ")
  ...
  private def doHandleStateChanges(
    ...
    //System.out.println("【日志】PartitionStateMachine.doHandleStateChanges() ")
  ...
  private def initializeLeaderAndIsrForPartitions(partitions: Seq[TopicPartition]): Seq[TopicPartition] = {
    ...
    //System.out.println("【日志】PartitionStateMachine.initializeLeaderAndIsrForPartitions() ")
  ...
  private def electLeaderForPartitions(
    ...
    //System.out.println("【日志】PartitionStateMachine.electLeaderForPartitions() ")
  ...
  private def doElectLeaderForPartitions(
    ...
    //System.out.println("【日志】PartitionStateMachine.doElectLeaderForPartitions() ")
  ...
  private def collectUncleanLeaderElectionState(
    ...
    //System.out.println("【日志】PartitionStateMachine.collectUncleanLeaderElectionState() ")
...
object PartitionLeaderElectionAlgorithms {
  def offlinePartitionLeaderElection(assignment: Seq[Int], isr: Seq[Int], liveReplicas: Set[Int], uncleanLeaderElectionEnabled: Boolean, controllerContext: ControllerContext): Option[Int] = {
    assignment.find(id => liveReplicas.contains(id) && isr.contains(id)).orElse {
      ...
      //System.out.println("【日志】PartitionStateMachine.PartitionLeaderElectionAlgorithms.offlinePartitionLeaderElection() ")
  ...
  def reassignPartitionLeaderElection(reassignment: Seq[Int], isr: Seq[Int], liveReplicas: Set[Int]): Option[Int] = {
    ...
    //System.out.println("【日志】PartitionStateMachine.PartitionLeaderElectionAlgorithms.reassignPartitionLeaderElection() ")
  ...
  def preferredReplicaPartitionLeaderElection(assignment: Seq[Int], isr: Seq[Int], liveReplicas: Set[Int]): Option[Int] = {
    ...
    //System.out.println("【日志】PartitionStateMachine.PartitionLeaderElectionAlgorithms.preferredReplicaPartitionLeaderElection() ")
  ...
  def controlledShutdownPartitionLeaderElection(assignment: Seq[Int], isr: Seq[Int], liveReplicas: Set[Int], shuttingDownBrokers: Set[Int]): Option[Int] = {
    ...
    //System.out.println("【日志】PartitionStateMachine.PartitionLeaderElectionAlgorithms.controlledShutdownPartitionLeaderElection() ")
