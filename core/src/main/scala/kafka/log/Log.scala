...
class Log(@volatile private var _dir: File,
  ...
  def appendAsLeader(records: MemoryRecords,
    ...
    //System.out.println("【日志】Log.appendAsLeader() records="+records+",leaderEpoch="+leaderEpoch);
  ...
  def appendAsFollower(records: MemoryRecords): LogAppendInfo = {
    ...
    //System.out.println("【日志】Log.appendAsFollower() records="+records);
  ...
  private def append(records: MemoryRecords,
    ...
    //System.out.println("【日志】Log.append() 消息写入本地log,records="+records);
  ...
  def maybeAssignEpochStartOffset(leaderEpoch: Int, startOffset: Long): Unit = {
    ...
    //System.out.println("【日志】Log.maybeAssignEpochStartOffset() leaderEpoch="+leaderEpoch+",startOffset="+startOffset);
  ...
  def endOffsetForEpoch(leaderEpoch: Int): Option[OffsetAndEpoch] = {
    ...
    //System.out.println("【日志】Log.endOffsetForEpoch() leaderEpoch="+leaderEpoch);
  ...
  def read(startOffset: Long,
    ...
    //System.out.println("【日志】Log.read() 读取log");
  ...
  private def deleteSegments(deletable: Iterable[LogSegment], reason: SegmentDeletionReason): Int = {
    ...
    //System.out.println("【日志】Log.deleteSegments() 删除日志段");
  ...
  private def deletableSegments(predicate: (LogSegment, Option[LogSegment]) => Boolean): Iterable[LogSegment] = {
    ...
    //System.out.println("【日志】Log.deleteOldSegments() 删除old日志段");
