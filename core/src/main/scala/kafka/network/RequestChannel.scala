...
class RequestChannel(val queueSize: Int,
  ...
  //System.out.println("【日志】RequestChannel.new() 初始化请求通道")
  ...
  def addProcessor(processor: Processor): Unit = {
    ...
    //System.out.println("【日志】RequestChannel.addProcessor() 缓存当前 processor")
  ...
  def sendRequest(request: RequestChannel.Request): Unit = {
    ...
    //System.out.println("【日志】RequestChannel.Request() 将请求添加到requestQueue队列,等待KafkaApis")
