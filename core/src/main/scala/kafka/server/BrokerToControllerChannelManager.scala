...
class BrokerToControllerChannelManagerImpl(
  ...
  //System.out.println("【日志】BrokerToControllerChannelManager.new()")
  ...
  def start(): Unit = {
    //System.out.println("【日志】BrokerToControllerChannelManagerImpl.start()")
    requestThread.start()
  }
  ...
  private[server] def newRequestThread = {
    ...
    //System.out.println("【日志】BrokerToControllerChannelManager.newRequestThread()")
  ...
  def sendRequest(
    ...
    //System.out.println("【日志】BrokerToControllerChannelManager.sendRequest() ")
