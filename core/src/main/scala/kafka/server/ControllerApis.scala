...
class ControllerApis(val requestChannel: RequestChannel,
  ...
  override def handle(request: RequestChannel.Request): Unit = {
    ...
    try {
      ...
      //System.out.println("【日志】ControllerApis.handle() 处理与数据请求:"+request)
      //System.out.println("【日志】ControllerApis.handle() request.header.apiKey:"+request.header.apiKey)
  ...
  def handleCreateTopics(request: RequestChannel.Request): Unit = {
    ...
    //System.out.println("【日志】ControllerApis.handleCreateTopics() 创建主题")
    ...
    def sendResponse(response: CreateTopicsResponseData): Unit = {
      ...
      //System.out.println("【日志】ControllerApis.sendResponse() 创建完毕返回响应")
