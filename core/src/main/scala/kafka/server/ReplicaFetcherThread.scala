...
class ReplicaFetcherThread(name: String,
  ...
  override def processPartitionData(topicPartition: TopicPartition,
    ...
    //System.out.println("【日志】ReplicaFetcherThread.processPartitionData() 处理FETCH回来的消息集合");

    //System.out.println("【日志】ReplicaFetcherThread.processPartitionData() topicPartition="+topicPartition);
    //System.out.println("【日志】ReplicaFetcherThread.processPartitionData() fetchOffset="+fetchOffset);
    //System.out.println("【日志】ReplicaFetcherThread.processPartitionData() partitionData="+partitionData);
...
//System.out.println("【日志】ReplicaFetchThread.fetchFromLeader() 从主副本节点FETCH数据,发送请求");
  ...
  override def truncate(tp: TopicPartition, offsetTruncationState: OffsetTruncationState): Unit = {
    ...
    //System.out.println("【日志】ReplicaFetcherThread.truncate() 根据 leader返回的 epoch值进行日志截断,OffsetTruncationState="+OffsetTruncationState);
  ...
  override def fetchEpochEndOffsets(partitions: Map[TopicPartition, EpochData]): Map[TopicPartition, EpochEndOffset] = {
    ...
    //System.out.println("【日志】ReplicaFetcherThread.fetchEpochEndOffsets() 向主副本发送 OffsetsForLeaderEpochRequest 请求");
    ...
    try {
      ...
      //System.out.println("【日志】ReplicaFetcherThread.fetchEpochEndOffsets() 获取到请求响应,response="+response);
