...
//System.out.println("【日志】ReplicaManager.completeDelayedFetchOrProduceRequests() 创建FETCH线程,定时向主副本发送FETCH请求");
  ...
  private def appendToLocalLog(internalTopicsAllowed: Boolean,
    ...
    //System.out.println("【日志】ReplicaManager.appendToLocalLog() 追加消息到本地log");
...
//System.out.println("【日志】ReplicaManager.fetchMessages() 从本地查询未同步数据");
...
//System.out.println("【日志】ReplicaManager.readFromLog() 从log读取");
...
//System.out.println("【日志】ReplicaManager.readFromLocalLog() 从本地log读取");
  ...
  def maybeUpdateMetadataCache(correlationId: Int, updateMetadataRequest: UpdateMetadataRequest) : Seq[TopicPartition] =  {
    ...
    //System.out.println("【日志】ReplicaManager.maybeUpdateMetadataCache() 更新元数据 updateMetadataRequest="+updateMetadataRequest);
  ...
  def becomeLeaderOrFollower(correlationId: Int,
    ...
    //System.out.println("【日志】ReplicaManager.becomeLeaderOrFollower()")
  ...
  private def makeLeaders(controllerId: Int,
    ...
    //System.out.println("【日志】ReplicaManager.makeLeaders() 分区副本处理")
  ...
  private def makeFollowers(controllerId: Int,
    ...
    //System.out.println("【日志】ReplicaManager.makeFollowers() 分区 partitionStates="+partitionStates)
  ...
  private def maybeShrinkIsr(): Unit = {
    ...
    //System.out.println("【日志】ReplicaManager.maybeShrinkIsr() ");
  ...
  def lastOffsetForLeaderEpoch(
    ...
    //System.out.println("【日志】ReplicaManager.lastOffsetForLeaderEpoch() 获取每个Partition最近上一次的leaderEpoch和对应的LEO");

    // 迭代requestedEpochInfo集合，返回请求中每个主题
    requestedEpochInfo.map { offsetForLeaderTopic =>
      // 遍历每个主题的每个分区 offsetForLeaderPartition
      val partitions = offsetForLeaderTopic.partitions.asScala.map { offsetForLeaderPartition =>
        val tp = new TopicPartition(offsetForLeaderTopic.topic, offsetForLeaderPartition.partition)
        getPartition(tp) match {
          // 分区在线
          case HostedPartition.Online(partition) =>
            // 从请求中取出 remoteLeaderEpochOpt
