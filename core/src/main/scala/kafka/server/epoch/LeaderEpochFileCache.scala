...
class LeaderEpochFileCache(topicPartition: TopicPartition,
  ...
  private def assign(entry: EpochEntry): Boolean = {
    ...
    //System.out.println("【日志】LeaderEpochFileCache.assign() entry="+entry);
  ...
  private def maybeTruncateNonMonotonicEntries(newEntry: EpochEntry): Unit = {
    ...
    //System.out.println("【日志】LeaderEpochFileCache.maybeTruncateNonMonotonicEntries() newEntry="+newEntry);
  ...
  private def removeFromEnd(predicate: EpochEntry => Boolean): Seq[EpochEntry] = {
    ...
    //System.out.println("【日志】LeaderEpochFilecache.removeFromEnd()");
  ...
  private def removeFromStart(predicate: EpochEntry => Boolean): Seq[EpochEntry] = {
    ...
    //System.out.println("【日志】LeaderEpochFilecache.removeFromStart()");
  ...
  def endOffsetFor(requestedEpoch: Int): (Int, Long) = {
    ...
    //System.out.println("【日志】LeaderEpochFileCache.endOffsetFor() requestedEpoch="+requestedEpoch);
    ...
    inReadLock(lock) {
      ...
      //System.out.println("【日志】LeaderEpochFileCache.endOffsetFor() requestedEpoch="+requestedEpoch+",epochAndOffset="+epochAndOffset);
  ...
  def truncateFromEnd(endOffset: Long): Unit = {
    ...
    //System.out.println("【日志】LeaderEpochFilecache.truncateFromEnd()");
  ...
  def truncateFromStart(startOffset: Long): Unit = {
    ...
    //System.out.println("【日志】LeaderEpochFilecache.truncateFromStart()");
