...
public class ReplicationControlManager {
    ...
    public void replay(TopicRecord record) {
        ...
        //System.out.println("【日志】ReplicationControlManager.replay() ");
    ...
    ControllerResult<CreateTopicsResponseData> createTopics(CreateTopicsRequestData request) {
        ...
        //System.out.println("【日志】replicationControlManager.createTopics() 副本管理器处理主题创建请求");
        ...
        ControllerResult<Map<ConfigResource, ApiError>> configResult = configurationControl.incrementalAlterConfigs(configChanges);
    ...
    private ApiError createTopic(CreatableTopic topic, List<ApiMessageAndVersion> records, Map<String, CreatableTopicResult> successes) {
        ...
        //System.out.println("【日志】ReplicationControlManager.createTopic() name:"+topic.name()+",numPartitions="+topic.numPartitions()+",replicationFactor="+topic.replicationFactor());

        // 组装分区信息,如果指定了了分区则按照指定执行,否则系统算法来计算指定
